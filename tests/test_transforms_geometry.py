...
def test_occupancy_grid_from_point_cloud_all_outside():
    ...
    grid = torram.transforms.geometry.occupancy_grid_from_point_cloud(pc, T, grid_size=grid_size, voxel_size=1)
...
def test_occupancy_grid_from_point_cloud_only_center():
    ...
    grid = torram.transforms.geometry.occupancy_grid_from_point_cloud(pc, T, grid_size=(3, 3, 3), voxel_size=1)
